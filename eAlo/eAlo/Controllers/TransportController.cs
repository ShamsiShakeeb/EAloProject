...
namespace eAlo.Controllers
{
    public class TransportController : Controller
    {
        ...
        // GET: Transport
        public ActionResult AutoService()
        {
        ...
        [HttpPost]
        public ActionResult AutoService(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
            ...
            String a0 = "পণ্যের ধরণ : " + item_type + " <br/> ";
        ...
        public ActionResult BycycleAndThreeWhiler()
        {
        ...
        [HttpPost]
        public ActionResult BycycleAndThreeWhiler(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String brand, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult MotorBikeAndScoter()
        {
            string sua = Request.UserAgent.Trim().ToLower();
        ...
        [HttpPost]
        public ActionResult MotorBikeAndScoter(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String brand, String model, String edition, String model_year, String mileage, String engine_capacity, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
            ...
            String a4 = "সংস্করণ : " + edition + " <br/> ";
            String a5 = "মডেল ইয়ার : " + model_year + " <br/> ";
            String a6 = "কিলোমিটার চলেছে : " + mileage + " <br/> ";
            String a7 = "ইঞ্জিন ক্ষমতা : " + engine_capacity + " <br/> ";
            String a8 = "বিবরণ : " + description + " <br/> ";

            mb.FixedDetails = a0 + a1 + a2 + a3 + a4 + a5 + a6 + a7;
            mb.UserDetails = a8;
        ...
        public ActionResult PartsAndAcessoris()
        {
        ...
        [HttpPost]
        public ActionResult PartsAndAcessoris(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult TracktorAndHeavyDuty()
        {
        ...
        [HttpPost]
        public ActionResult TracktorAndHeavyDuty(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult TrackVanBus()
        {
            string sua = Request.UserAgent.Trim().ToLower();
        ...
        [HttpPost]
        public ActionResult TrackVanBus(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String brand, String model, String model_year, String mileage, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
            ...
            String a2 = "ব্র্যান্ড : " + brand + " <br/> ";
            String a3 = "মডেল : " + model + " <br/> ";
            String a4 = "মডেল ইয়ার : " + model_year + " <br/> ";
            String a5 = "কিলোমিটার চলেছে : " + mileage + " <br/> ";
            String a6 = "বিবরণ : " + description + " <br/> ";

            mb.FixedDetails = a0 + a1 + a2 + a3 + a4 + a5;
            mb.UserDetails = a6;
        ...
        public ActionResult WaterTransport()
        {
        ...
        [HttpPost]
        public ActionResult WaterTransport(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
