...
namespace eAlo.Controllers
{
    public class ServiceController : Controller
    {
        ...
        // GET: Service
        public ActionResult BusinessAndTechnologyService()
        {
        ...
        [HttpPost]
        public ActionResult BusinessAndTechnologyService(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
        ...
        public ActionResult EventAndRelatives()
        {
            string sua = Request.UserAgent.Trim().ToLower();
        ...
        [HttpPost]
        public ActionResult EventAndRelatives(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult FamillyAndPersonal()
        {
        ...
        [HttpPost]
        public ActionResult FamillyAndPersonal(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult HelathAndLifeStyle()
        {
        ...
        [HttpPost]
        public ActionResult HelathAndLifeStyle(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        [HttpPost]
        public ActionResult Ticket(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult VisitAndVisa()
        {
            string sua = Request.UserAgent.Trim().ToLower();
        ...
        [HttpPost]
        public ActionResult VisitAndVisa(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
