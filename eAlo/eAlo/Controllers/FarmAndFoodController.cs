...
{
    public class FarmAndFoodController : Controller
    {
        ...
        // GET: FarmAndFood
        public ActionResult CroopsSeedsAndPlants()
        {
        ...
        [HttpPost]
        public ActionResult CroopsSeedsAndPlants(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String title, String description, String price2, String negotiable)
        {
        ...
        public ActionResult FarmEquioment()
        {
        ...
        [HttpPost]
        public ActionResult FarmEquioment(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        [HttpPost]
        public ActionResult Food(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult OtherFramAndFood()
        {
        ...
        [HttpPost]
        public ActionResult OtherFramAndFood(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
