...
{
    public class BusinessAndIndustryController : Controller
    {
        ...
        // GET: BusinessAndIndustry

        public ActionResult IndustryAndMeterials()
        {
        ...
        [HttpPost]
        public ActionResult IndustryAndMeterials(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String title, String description, String price2, String negotiable)
        {
        ...
        public ActionResult LicenseOwnershipAndTender()
        {
        ...
        [HttpPost]
        public ActionResult LicenseOwnershipAndTender(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4,String title , String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
            ...
            String a0 = "বিজ্ঞাপন শিরোনাম : " + title + " <br/> ";
            String a1 = "বিবরণ : " + description + " <br/> ";
        ...
        public ActionResult MedicalEqipmentAndSupply()
        {
        ...
        [HttpPost]
        public ActionResult MedicalEqipmentAndSupply(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult OfficeAndStationary()
        {
        ...
        [HttpPost]
        public ActionResult OfficeAndStationary(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4,String condition , String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult OtherBusinessAndIndustrialProduct()
        {
        ...
        [HttpPost]
        public ActionResult OtherBusinessAndIndustrialProduct(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult RawMaterialsAndFactorySupplies()
        {
        ...
        [HttpPost]
        public ActionResult RawMaterialsAndFactorySupplies(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult SafetyAndSecuirty()
        {
        ...
        [HttpPost]
        public ActionResult SafetyAndSecuirty(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
