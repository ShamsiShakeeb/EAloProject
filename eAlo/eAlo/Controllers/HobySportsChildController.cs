...
{
    public class HobySportsChildController : Controller
    {
        ...
        // GET: HobySportsChild
        public ActionResult ChildernPlaystoreAndItem()
        {
        ...
        [HttpPost]
        public ActionResult ChildernPlaystoreAndItem(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String gender, String title, String description, String price2, String negotiable)
        {
        ...
        public ActionResult FitnessAndGym()
        {
            string sua = Request.UserAgent.Trim().ToLower();
        ...
        [HttpPost]
        public ActionResult FitnessAndGym(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String gender, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult HobySportAndChildernOtherProduct()
        {
        ...
        [HttpPost]
        public ActionResult HobySportAndChildernOtherProduct(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult MusicalInstruments()
        {
        ...
        [HttpPost]
        public ActionResult MusicalInstruments(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        public ActionResult SingingBookMovie()
        {
            string sua = Request.UserAgent.Trim().ToLower();
        ...
        [HttpPost]
        public ActionResult SingingBookMovie(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
        ...
        [HttpPost]
        public ActionResult Sports(HttpPostedFileBase Image, HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, String condition, String item_type, String title, String description, String price2, String negotiable)
        {
            TheValues tv = new TheValues();
